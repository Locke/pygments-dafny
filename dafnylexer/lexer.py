...
class DafnyLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(function|method|datatype|predicate|lemma)', Keyword.Declaration),
            (r'(trait|class)(\s+)(\w+)', bygroups(Keyword.Declaration, Text, Name.Class)),
            (r'(trait|class)', Keyword.Declaration),
